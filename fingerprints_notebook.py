        ...
        admet_compare_view = mo.vstack(
            [
                mo.md(
                    ...
                    "— in advance\n\n"
                    "The same census across **three** ADMET endpoints, now broken "
                    "out by fingerprint:"
                ),
                mo.as_html(_chart),
                mo.md(
                    "Two things jump out, and **both are only knowable after you "
                    "have the data**:\n\n"
                    "1. **Cliffiness swings by target.** Aqueous solubility is "
                    "riddled with cliffs (a third of similar pairs!), "
                    "lipophilicity far less, and Caco-2 permeability barely any. "
                    "Solubility hinges on crystal packing and H-bonding a single "
                    "atom can shatter; logD is a smoother bulk average.\n\n"
                    "2. **No fingerprint is safest everywhere.** On solubility "
                    "**atom-pair** flags *far* fewer cliffs than Morgan or MACCS "
                    "— its distance-based similarity happens to align with what "
                    "drives solubility — but that lead evaporates on lipophilicity, "
                    "and MACCS is consistently the cliffiest. You could only *learn* "
                    "atom-pair suits solubility by measuring it first.\n\n"
                    "So the honest posture on a fresh target is humility: you don't "
                    "know how cliffy it is, or which encoding will cope, until you "
                    "have data in hand."
                ).callout(kind="info"),
                mo.md("---"),
            ]
